...
The research question, how frequent is ADM in different stages of lobular atrophy
K19 (ductal marker) and Amylase (acinar marker) expression, if double positive, cells can be consiedered early ADM.
...
With Grouping based on pathologist's classification of lobular atrophy
...
dp_boxplot_with_sign_all3 # Fig 3e
