...
setwd("/Users/sara.soderqvist/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Writing_/Adaptive PDAC paper/Source data/m-IF stroma/file dir") #adjust the working directory to read in the csv file
...
library(dichromat)
# non-Vimentin
Venn_NGFR_nonVim <- ggVennDiagram(lapply(NGFR_Venn[, c(2, 3, 5)], function (x)
  which(x == 1)))
...
#option_for_Fig_4g_right_panel <- Venn_all_NGFR
#option_for_Fig_4g_right_panel
Fig_4g_right_panel <- Venn_all_NGFR_nonVim
Fig_4g_right_panel
...
#For now, any cell positive will be counted as positive, so now not questioning weather individual cells are double, triple, quadraple positive.
