...
### CAF subtype plots in the based on expression of single m-IF markers
## Update from 2024 05 24: addding paired parameted to stat tests

``` {r Data cleaunup_intensity cell, echo = FALSE, message = FALSE, results = "hide", warning = FALSE}
setwd("/Users/sara.soderqvist/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Writing_/Adaptive PDAC paper/Source data/m-IF stroma/file dir")
...
Suppl_Fig_12b <- Dunn_boxes_comp_sp

Fig_4e <- Dunn_boxes_sp
