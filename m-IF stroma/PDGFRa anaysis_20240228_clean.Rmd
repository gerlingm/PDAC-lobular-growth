...
---
Goal: show how the expression profile of stroma cell in stroma-transformed/desmoplastic compartment is. 
We have shown that in lobules, NGFR+ stroma cells frequently co-express PDGFRa (we term these nCAFs). 

To show that these are separated from the PDGFRa+ cells in stroma-transformed/desmoplastic compartment (our iCAF proxy), we want to, in particular, show that these stroma cells have lost the NGFR expression.
...
setwd("/Users/sara.soderqvist/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Writing_/Adaptive PDAC paper/Source data/m-IF stroma/file dir") #Adjust the working directory to read in the file from
