...
# Intratumoral heterogeneity in murine PDAC: HMGA2 quantification in lobular and stromal compartment

## Import the data

```{r results='asis'}
HMGA2.data_ori <- read.table('./data/HMGA2_AMY_mice_detections.tsv',
                                  sep = '\t', header = T)
